...
Check_data_4G
    ...
    Page Should Contain Element    //*[@id="report-table_wrapper"]/div/div/div/table/thead/tr/th[contains(text(),'4G_EPS_BA_SUCR')]
    Page Should Contain Element    //*[@id="report-table_wrapper"]/div/div/div/table/thead/tr/th[contains(text(),'4G_S1_HO_SUCR')]
    Page Should Contain Element    //*[@id="report-table_wrapper"]/div/div/div/table/thead/tr/th[contains(text(),'4G_X2_HO_SUCR')]
    Page Should Contain Element    //*[@id="report-table_wrapper"]/div/div/div/table/thead/tr/th[contains(text(),'4G_PS_IRAT_4G_SUCR')]
    Page Should Contain Element    //*[@id="report-table_wrapper"]/div/div/div/table/thead/tr/th[contains(text(),'4G_CSFB_SUCR')]
    Page Should Contain Element    //*[@id="report-table"]/tbody/tr[1]